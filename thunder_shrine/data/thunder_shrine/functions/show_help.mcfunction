...
tellraw @s ["",{"text":"1. ","color":"green"},{"text":"Place down any normal armour stand","color":"gold"}]
tellraw @s ["",{"text":"2. ","color":"green"},{"text":"Run ","color":"gold"},{"text":"/function thunder_shrine:create","color":"green"}]
tellraw @s ["",{"text":"3. ","color":"green"},{"text":"The nearest armour stand within 3 blocks will be converted","color":"gold"}]
