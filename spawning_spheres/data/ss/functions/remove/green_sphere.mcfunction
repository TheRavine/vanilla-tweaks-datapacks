...
execute if score #ss_isGreen ss_isGreen matches 1.. as @s[scores={ss_removeGreen=1}] at @s run function ss:get_player_info
execute if score #ss_isGreen ss_isGreen matches 1.. as @s[scores={ss_removeGreen=1}] at @s run function ss:tp/green_sphere
...
execute if score #ss_isGreen ss_isGreen matches 1.. as @s[scores={ss_removeGreen=21}] at @s run function ss:tp/back
