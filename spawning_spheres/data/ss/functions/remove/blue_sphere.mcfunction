...
execute if score #ss_isBlue ss_isBlue matches 1.. as @s[scores={ss_removeBlue=1}] at @s run function ss:get_player_info
execute if score #ss_isBlue ss_isBlue matches 1.. as @s[scores={ss_removeBlue=1}] at @s run function ss:tp/blue_sphere
...
execute if score #ss_isBlue ss_isBlue matches 1.. as @s[scores={ss_removeBlue=21}] at @s run function ss:tp/back
