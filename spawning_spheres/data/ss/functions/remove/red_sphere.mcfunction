...
execute if score #ss_isRed ss_isRed matches 1.. as @s[scores={ss_removeRed=1}] at @s run function ss:get_player_info
execute if score #ss_isRed ss_isRed matches 1.. as @s[scores={ss_removeRed=1}] at @s run function ss:tp/red_sphere
...
execute if score #ss_isRed ss_isRed matches 1.. as @s[scores={ss_removeRed=21}] at @s run function ss:tp/back
