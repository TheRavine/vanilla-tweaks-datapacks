...
execute if score #ss_isBlue ss_isBlue matches ..0 align xyz positioned ~0.5 ~ ~0.5 run function ss:spheres/blue_sphere
execute if score #ss_isBlue ss_isBlue matches ..0 align xyz positioned ~0.5 ~ ~0.5 run function ss:spheres/large_blue_sphere
...
execute if score #ss_isBlue ss_isBlue matches 1.. align xyz positioned ~0.5 ~0.5 ~0.5 run tellraw @s [{"text":"A blue sphere already exists!","color":"red"},{"text":" Click here to remove it!","color":"yellow","clickEvent":{"action":"run_command","value":"/function ss:remove/blue_sphere"},"hoverEvent":{"action":"show_text","value":"Runs /function ss:remove/blue_sphere"}}]
