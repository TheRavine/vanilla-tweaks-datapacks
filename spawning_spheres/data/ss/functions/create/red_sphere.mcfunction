...
execute if score #ss_isRed ss_isRed matches ..0 align xyz positioned ~0.5 ~ ~0.5 run function ss:spheres/red_sphere
execute if score #ss_isRed ss_isRed matches ..0 align xyz positioned ~0.5 ~ ~0.5 run function ss:spheres/large_red_sphere
...
execute if score #ss_isRed ss_isRed matches 1.. align xyz positioned ~0.5 ~0.5 ~0.5 run tellraw @s [{"text":"A red sphere already exists!","color":"red"},{"text":" Click here to remove it!","color":"yellow","clickEvent":{"action":"run_command","value":"/function ss:remove/red_sphere"},"hoverEvent":{"action":"show_text","value":"Runs /function ss:remove/red_sphere"}}]
