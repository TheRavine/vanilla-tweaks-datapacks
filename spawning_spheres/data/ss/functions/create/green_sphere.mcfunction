...
execute if score #ss_isGreen ss_isGreen matches ..0 align xyz positioned ~0.5 ~ ~0.5 run function ss:spheres/green_sphere
execute if score #ss_isGreen ss_isGreen matches ..0 align xyz positioned ~0.5 ~ ~0.5 run function ss:spheres/large_green_sphere
...
execute if score #ss_isGreen ss_isGreen matches 1.. align xyz positioned ~0.5 ~0.5 ~0.5 run tellraw @s [{"text":"A green sphere already exists!","color":"red"},{"text":" Click here to remove it!","color":"yellow","clickEvent":{"action":"run_command","value":"/function ss:remove/green_sphere"},"hoverEvent":{"action":"show_text","value":"Runs /function ss:remove/green_sphere"}}]
