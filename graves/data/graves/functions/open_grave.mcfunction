...
execute if score #rotated graves.dummy matches 1.. unless score #remaining graves.dummy matches 0 run function graves:rotate/back_grave
...
particle minecraft:poof ~ ~0.5 ~ 0 0 0 0.05 10
kill @s
