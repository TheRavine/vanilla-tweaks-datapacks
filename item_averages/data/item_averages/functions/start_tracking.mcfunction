...
function item_averages:calculate_values
...
execute unless entity @e[tag=ia_pointDisplay] run function item_averages:reset_data_point
function item_averages:output_average
