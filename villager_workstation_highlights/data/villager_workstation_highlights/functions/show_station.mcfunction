...
execute store result entity @e[type=armor_stand,tag=vwh_armor_stand,sort=nearest,limit=1] Pos[0] double 1.0 run data get entity @s Brain.memories."minecraft:job_site".pos[0]
execute store result entity @e[type=armor_stand,tag=vwh_armor_stand,sort=nearest,limit=1] Pos[1] double 1.0 run data get entity @s Brain.memories."minecraft:job_site".pos[1]
execute store result entity @e[type=armor_stand,tag=vwh_armor_stand,sort=nearest,limit=1] Pos[2] double 1.0 run data get entity @s Brain.memories."minecraft:job_site".pos[2]
