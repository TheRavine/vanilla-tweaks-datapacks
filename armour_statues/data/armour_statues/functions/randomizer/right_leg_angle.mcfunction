...
# Called by:	armour_statues:randomizer/right_leg
...
execute if predicate armour_statues:random_chance_30 run scoreboard players set #random_type as_angle 1
execute if score #random_type as_angle matches 1 if predicate armour_statues:random_chance_50 run scoreboard players set #random_type as_angle 2
# crossing reduction
scoreboard players set #no_crossing as_angle 0
execute if predicate armour_statues:random_chance_85 run scoreboard players set #no_crossing as_angle 1
