...
# Called by:	armour_statues:randomizer/head
...
execute if predicate armour_statues:random_chance_20 run scoreboard players set #random_type as_angle 1
execute if score #random_type as_angle matches 1 if predicate armour_statues:random_chance_40 run scoreboard players set #random_type as_angle 2
# negative modulo
