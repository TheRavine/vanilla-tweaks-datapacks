...
# Called by:	armour_statues:randomizer/body
...
execute if predicate armour_statues:random_chance_10 run scoreboard players set #random_type as_angle 1
execute if score #random_type as_angle matches 1 if predicate armour_statues:random_chance_30 run scoreboard players set #random_type as_angle 2
# negative modulo
