...
tellraw @s ["",{"text":"Mob Death Counter config:","color":"yellow","bold":"true"}]
...
tellraw @s ["",{"text":"4. ","color":"green"},{"text":"Toggle scoreboard","color":"yellow","clickEvent":{"action":"run_command","value":"/trigger md_toggle"},"hoverEvent":{"action":"show_text","value":"Click to run command"}}]
